...
//1)Imprima por consola hola mundo
//        System.out.println("*Hello World*");

//2)cree un vector de 20 elementos con valores numericos diferentes. Hallar el mayor valor y su posicion y calcular el promedio.
//        int suma = 0;
//        double promedio = 0;
...
//3)crear una matriz n x m llenarla utilizando el metodo math.random y ordenarla de manera descendente

        //Creamos una matriz cuadrada de tamaño 5 x 5, es decir, 5 filas y 5 columnas
        int[][] matriz = new int[5][5];
        // creamos dos for para recorrer cada posicion de la matriz y agregar el número
        for (
                int i = 0;
                i < matriz.length; i++) {
            for (int j = 0; j < matriz.length; j++) {
                //Para poder generar el número aleatorio, en este caso entre el 1 y el 10, utilizamos el método .random() de la clase Math.
                // Este método nos devuelve un número entre el 0.0 y el 1.0, que multiplicándolo por 10 nos da un número aleatorio entre 1 y 10
...
//3)Escriba un programa en java que lea dos caracteres cualquiera y compruebe si son iguales. Escribir en consola el resultado de dicha comparación “Son iguales” o “Son diferentes”
